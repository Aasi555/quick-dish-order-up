...
INSERT INTO public.menu_items (category, name, size, price, temperature) VALUES
-- Veg items
('veg', 'Paneer Butter Masala', 'Full', 280, NULL),
('veg', 'Paneer Butter Masala', 'Half', 180, NULL),
('veg', 'Dal Tadka', 'Full', 200, NULL),
('veg', 'Dal Tadka', 'Half', 120, NULL),
('veg', 'Veg Biryani', 'Full', 250, NULL),
('veg', 'Mix Veg', 'Full', 220, NULL),
('veg', 'Mix Veg', 'Half', 140, NULL),
('veg', 'Rajma', 'Full', 200, NULL),
('veg', 'Rajma', 'Half', 120, NULL),

-- Non-veg items
('nonVeg', 'Chicken Curry', 'Full', 350, NULL),
('nonVeg', 'Chicken Curry', 'Half', 220, NULL),
('nonVeg', 'Mutton Curry', 'Full', 450, NULL),
('nonVeg', 'Mutton Curry', 'Half', 280, NULL),
('nonVeg', 'Chicken Biryani', 'Full', 320, NULL),
('nonVeg', 'Fish Curry', 'Full', 300, NULL),
('nonVeg', 'Fish Curry', 'Half', 200, NULL),
